...
Inside the parking garage, there are other "users". The visitor itself, who is a person that wants to park inside the garage, and a lot of facilities, that communicate with the parking management software, to manage the user.

<img src="./img/useCase_diagram.png" width="50%">

In this case, the visitor wants following things:
1. As a visitor, I want to be able to enter the garage and resieve a ticket from the entry barrier. Therefore my visit needs to be stored within the parking management service.
...
3. As a visitor, I want to leave the parking garage after my visit. Therefore my tickets needs to be checked.
4. As a visitor, I want to see the current occupancy of the parking garage on a sign.
...
### Components
In the following application the services are listed.

<img src="./img/componentsDiagram.png" width="80%">


The components are:
- **Keycloak**: Authentication Service to manage the tenants, users and rights
...
For each microservice exists a plan of a data structure and the stored data. Planned like shown below.
...
### Tenant Type Access and Features
...
| Hardware APIs              | limited                                       | most supported                                         | unlimited          |
...
|                            |                                               |                                                        |                    |
| **Customization**          |                                               |                                                        |                    |
| Parking prices             | one price                                     | day/night                                              | unlimited          |
